...
const MACHINE_Y_PCT = 55;
const MACHINE_W_VH = 22;

/** Machine source-image aspect ratio (width / height). */
const MACHINE_ASPECT = 518 / 734;

const MACHINE_H_VH = MACHINE_W_VH / MACHINE_ASPECT;

export { MACHINE_X_PCT, MACHINE_Y_PCT, MACHINE_W_VH, MACHINE_H_VH, MACHINE_ASPECT };
...
export class Machine {
  ...
  private buildWrapper(): HTMLElement {
    ...
    Object.assign(wrapper.style, {
      ...
      left:            `${MACHINE_X_PCT}%`,
      top:             `${MACHINE_Y_PCT}%`,
      width:           `${MACHINE_W_VH * CONFIG.sizeFactor}vh`,
      height:          `${MACHINE_H_VH * CONFIG.sizeFactor}vh`,
